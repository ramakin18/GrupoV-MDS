...
export const create = (req: Request, res: Response) => {
    try {
        ...
        if (price < 0) {
            return res.status(400).json({ message: "El precio debe ser 0 o un valor positivo." });
        }
        // Validamos que el sea mayor o igual a 0.
        if (stock < 0) {
        ...
        // Captura de errores por parte del service.
